...
This repo contains runtimes for the AXIA, Kusama, and AlphaNet networks. The README provides
...
```
# Import the security@axiacoin.network GPG key
...
dnf config-manager --add-repo https://releases.axiacoin.network/rpm/axia.repo
...
This repo supports runtimes for AXIA, Kusama, and AlphaNet.
...
If you want to do anything on AXIA, Kusama, or AlphaNet, then you'll need to get an account and
