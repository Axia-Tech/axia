...
pub type WococoMessagesToBetaNet =
	SubstrateMessageLaneToSubstrate<Wococo, WococoSigningParams, BetaNet, BetaNetSigningParams>;

impl SubstrateMessageLane for WococoMessagesToBetaNet {
...
type WococoSourceClient =
	SubstrateMessagesSource<Wococo, WococoMessagesToBetaNet, relay_wococo_client::runtime::WithBetaNetMessagesInstance>;

/// BetaNet node as messages target.
type BetaNetTargetClient =
	SubstrateMessagesTarget<BetaNet, WococoMessagesToBetaNet, relay_betanet_client::runtime::WithWococoMessagesInstance>;
