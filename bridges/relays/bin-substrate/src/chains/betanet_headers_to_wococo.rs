...
pub(crate) type BetaNetFinalityToWococo = SubstrateFinalityToSubstrate<BetaNet, Wococo, WococoSigningParams>;

impl SubstrateFinalitySyncPipeline for BetaNetFinalityToWococo {
	...
	fn customize_metrics(params: MetricsParams) -> anyhow::Result<MetricsParams> {
		crate::chains::add_axia_kusama_price_metrics::<Self>(params)
	}
