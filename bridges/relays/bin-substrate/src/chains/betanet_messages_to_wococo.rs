...
type BetaNetSourceClient =
	SubstrateMessagesSource<BetaNet, BetaNetMessagesToWococo, relay_betanet_client::runtime::WithWococoMessagesInstance>;

/// Wococo node as messages target.
type WococoTargetClient =
	SubstrateMessagesTarget<Wococo, BetaNetMessagesToWococo, relay_wococo_client::runtime::WithBetaNetMessagesInstance>;
