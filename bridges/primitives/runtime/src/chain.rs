...
pub trait Chain: Send + Sync + 'static {
	...
	// https://crates.axiacoin.network/sp_runtime/traits/trait.Header.html#associatedtype.Number
	//
	...
	// See here for more info:
	// https://crates.axiacoin.network/sp_runtime/traits/trait.Header.html#associatedtype.Hash
	type Hash: Parameter
		+ Member
		+ MaybeSerializeDeserialize
		+ sp_std::hash::Hash
	...
	// See here for more info:
	// https://crates.axiacoin.network/sp_runtime/traits/trait.Header.html#associatedtype.Hashing
	type Hasher: HashT<Output = Self::Hash>;

	/// A type that fulfills the abstract idea of what a Substrate header is.
	// See here for more info:
	// https://crates.axiacoin.network/sp_runtime/traits/trait.Header.html
