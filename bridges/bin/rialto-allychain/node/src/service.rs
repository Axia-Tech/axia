...
// Local Runtime Types
use rialto_allychain_runtime::RuntimeApi;
...
pub type AllychainRuntimeExecutor = ExecutorDispatch;
...
impl NativeExecutionDispatch for ExecutorDispatch {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		rialto_allychain_runtime::api::dispatch(method, data)
	}

	fn native_version() -> sc_executor::NativeVersion {
		rialto_allychain_runtime::native_version()
	}
}
...
/// Build the import queue for the the allychain runtime.
#[allow(clippy::type_complexity)]
pub fn allychain_build_import_queue(
	client: Arc<TFullClient<Block, RuntimeApi, NativeElseWasmExecutor<AllychainRuntimeExecutor>>>,
	config: &Configuration,
	...
	sc_consensus::DefaultImportQueue<
		Block,
		TFullClient<Block, RuntimeApi, NativeElseWasmExecutor<AllychainRuntimeExecutor>>,
	>,
	sc_service::Error,
> {
...
pub async fn start_node(
	...
	start_node_impl::<RuntimeApi, AllychainRuntimeExecutor, _, _, _>(
		allychain_config,
		axia_config,
		id,
		|_| Default::default(),
