...
use axctest_runtime_constants::{currency::*, fee::*, time::*};
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		ParasDisputes: allychains_disputes::{Pallet, Call, Storage, Event<T>} = 62,
...
impl RefundNickPalletDeposit {
	fn execute(check: bool) -> Weight {
		let accounts_and_deposits = vec![
			...
			(
				// H1ye1dQ7zVM8obAmb21kfUKA8otRekWXn6fiToAxiaTestJK9
				[
