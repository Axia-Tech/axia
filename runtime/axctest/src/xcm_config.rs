...
parameter_types! {
	...
	pub const AxiaTestForStatemine: (MultiAssetFilter, MultiLocation) = (AxiaTest::get(), Allychain(1000).into());
	pub const AxiaTestForEncointer: (MultiAssetFilter, MultiLocation) = (AxiaTest::get(), Allychain(1001).into());
}
pub type TrustedTeleporters =
	(xcm_builder::Case<AxiaTestForStatemine>, xcm_builder::Case<AxiaTestForEncointer>);
