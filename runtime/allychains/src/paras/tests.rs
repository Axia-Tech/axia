...
fn upgrade_restriction_elapsed_doesnt_mean_can_upgrade() {
	// Situation: allychain scheduled upgrade but it doesn't produce any candidate after
	// `expected_at`. When `validation_upgrade_cooldown` elapsed the allychain produces a
