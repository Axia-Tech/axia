...
mod enter {
	...
	fn include_backed_candidates() {
		new_test_ext(MockGenesisConfig::default()).execute_with(|| {
			...
			inherent_data
				.put_data(ALLYCHAINS_INHERENT_IDENTIFIER, &expected_para_inherent_data)
				.unwrap();
	...
	fn inherent_data_weight(inherent_data: &AllychainsInherentData) -> Weight {
...
mod sanitizers {
	...
	use primitives::v0::ALLYCHAIN_KEY_TYPE_ID;
